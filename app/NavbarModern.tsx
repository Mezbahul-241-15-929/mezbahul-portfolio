          ...
          <div className="flex justify-between items-center h-12">
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <motion.a
                    ...
                    className={`relative px-4 py-2 rounded-lg font-medium text-sm cursor-pointer transition-all duration-300 group`}
                    whileHover={{ y: -2 }}
                  >
                    {/* Background */}
            ...
            >
              <a
                ...
                className="relative px-6 py-2 text-sm font-semibold text-white overflow-hidden rounded-lg group inline-flex items-center gap-2 transition-all duration-300 shadow-lg shadow-blue-500/30 hover:shadow-cyan-500/60"
              >
                {/* Gradient background */}
            ...
            >
              <a
                href="#contact"
                onClick={(e) => handleNavLinkClick(e, 'contact')}
                className="relative px-3 py-1.5 text-xs font-semibold text-white overflow-hidden rounded-md group inline-flex items-center gap-1 transition-all duration-300 shadow-lg shadow-blue-500/30 hover:shadow-cyan-500/60"
              >
                {/* Gradient background */}
