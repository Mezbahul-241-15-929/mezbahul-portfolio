        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-16">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4">
              Contests &amp; <span className="bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Competitions</span>
              <div className="h-1 w-32 bg-linear-to-r from-blue-400 to-cyan-400 mt-4"></div>
            </h1>
            <p className="text-gray-400 text-lg mt-4">A collection of all the contests and competitions I have participated in</p>
          </div>
            ...
            {contests.map((contest) => (
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white flex-1">{contest.name}</h3>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">{contest.date}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium text-sm">{contest.organizer}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium text-sm">{contest.description}</p>
                    </div>
                  </div>
                </div>
          ...
          {contests.length === 0 && (
            <div className="text-center py-20">
              <p className="text-gray-400 text-lg">No contests found. Please check back later.</p>
            </div>
          )}
        </div>
      </section>
